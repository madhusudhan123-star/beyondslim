        ...
        home: {
            ...
            testimonials: {
                ...
                benefits: [
                  {
                    icon: "<Target className='h-8 w-8 text-blue-600' />",
                    title: "जिद्दी चर्बी को टारगेट करें",
                    description: "उन्नत बॉडी-मैपिंग तकनीक के माध्यम से जिद्दी चर्बी जमा को सटीक रूप से टारगेट करता है"
                  },
                  {
                    icon: "<Droplets className='h-8 w-8 text-blue-600' />",
                    title: "प्राकृतिक सामग्री",
                    description: "100% प्राकृतिक वनस्पति अर्क जो आपके शरीर के साथ तालमेल में काम करता है"
                  },
                  {
                    icon: "<Clock className='h-8 w-8 text-blue-600' />",
                    title: "तेज असर वाला फॉर्मूला",
                    description: "नियमित उपयोग के साथ केवल 4 सप्ताह में दिखाई देने वाले परिणाम प्राप्त करें"
                  },
                  {
                    icon: "<Shield className='h-8 w-8 text-blue-600' />",
                    title: "क्लिनिकल परीक्षण किया गया",
                    description: "सभी प्रकार की त्वचा के लिए डर्माटोलॉजिकल परीक्षण और प्रमाणित सुरक्षित"
                  }
                ],
                howItWorks: {
    ...
    AR:{
        ...
        home: {
            ...
            benefits: [
                {
                    icon: <Target className="h-8 w-8 text-blue-600" />,
                    title: "استهداف الدهون العنيدة",
                    description: "يستهدف رواسب الدهون العنيدة بدقة من خلال تقنية رسم الجسم المتقدمة"
                },
                {
                    icon: <Droplets className="h-8 w-8 text-blue-600" />,
                    title: "مكونات طبيعية",
                ...
                },
                {
                    ...
                    description: "رؤية نتائج ملحوظة في غضون 4 أسابيع فقط مع الاستخدام المنتظم"
                },
                {
                    icon: <Shield className="h-8 w-8 text-blue-600" />,
                    title: "مُختبر سريريًا",
                    description: "مُختبر من قبل أطباء الجلدية ومُثبت أنه آمن لجميع أنواع البشرة"
                }
            ],
            howItWorks: {
